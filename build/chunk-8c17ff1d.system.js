...
System.register([], function (exports, module) {
    ...
    return {
        execute: function () {
            var _this = this;
            exports('g', globals);
            var BUILD = { "allRenderFn": true, "cmpDidLoad": true, "cmpDidUnload": false, "cmpDidUpdate": true, "cmpDidRender": false, "cmpWillLoad": true, "cmpWillUpdate": true, "cmpWillRender": false, "connectedCallback": false, "disconnectedCallback": false, "element": false, "event": false, "hasRenderFn": true, "lifecycle": true, "hostListener": true, "hostListenerTargetWindow": true, "hostListenerTargetDocument": true, "hostListenerTargetBody": false, "hostListenerTargetParent": false, "hostListenerTarget": true, "member": true, "method": false, "mode": true, "noVdomRender": false, "observeAttribute": true, "prop": true, "propBoolean": true, "propNumber": true, "propString": true, "propMutable": false, "reflect": false, "scoped": false, "shadowDom": true, "slot": true, "slotRelocation": true, "state": true, "style": true, "svg": true, "updatable": true, "vdomAttribute": true, "vdomClass": true, "vdomFunctional": true, "vdomKey": true, "vdomListener": true, "vdomRef": true, "vdomRender": true, "vdomStyle": true, "vdomText": true, "watchCallback": false, "taskQueue": true, "lazyLoad": true, "hydrateServerSide": false, "cssVarShim": true, "hydrateClientSide": false, "isDebug": false, "isDev": true, "lifecycleDOMEvents": false, "profile": false, "hotModuleReplacement": true, "constructableCSS": false, "cssAnnotations": true };
            var NAMESPACE = 'elektrilevi-ui';
            var win = window;
            var doc = document;
            var H = HTMLElement;
            var plt = {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            // @ts-ignore
                            return [4 /*yield*/, module.import('./dom-a0c82e31-a8fc097f.system.js')];
                        case 2:
                            // @ts-ignore
                            _a.sent();
                            _a.label = 3;
            ...
            var getContext = exports('d', function (_elm, context) {
                ...
                if ('undefined' !== typeof window && window.addEventListener) {
                    var e = Object.create(null), l, d = function () { clearTimeout(l); l = setTimeout(n, 100); }, m = function () { }, t = function () {
                        ...
                        if (window.MutationObserver) {
                            ...
                            document.documentElement.addEventListener('DOMSubtreeModified', d, !1), m = function () { document.documentElement.removeEventListener('DOMSubtreeModified', d, !1); window.removeEventListener('resize', d, !1); window.removeEventListener('orientationchange', d, !1); };
                    }, u = function (k) {
                        function e(a) { if (void 0 !== a.protocol)
                            var c = a;
                        else
                            c = document.createElement('a'), c.href = a; return c.protocol.replace(/:/g, '') + c.host; }
                    ...
                    var p = function () { window.removeEventListener('load', p, !1); l = setTimeout(n, 0); };
            ...
            window.OpenModal = function (modalId) {
                ...
                if (!modal) {
                    return console.error('Modal not found with id: ', modalId);
                }
