...
class SectionBlock {
    constructor(hostRef) {
        ...
        this.backgroundStyles = () => this.backgroundImage !== ''
            ? {
                background: `url(${this.backgroundImage}) left center no-repeat`,
                height: '100%',
        ...
        this.imgClasses = () => {
            return {
                ...
                'section-img': this.backgroundImage !== '',
                'image-overlay': this.hasImageOverlay
            };
        };
        this.classes = () => {
            return {
                outer__container: true,
                'section--diagonal': this.isDiagonal,
                [`section--${this.backgroundColor}`]: this.backgroundColor !== '',
                'section--diagonal-space': this.diagonalSpace,
                wide: this.isWide,
